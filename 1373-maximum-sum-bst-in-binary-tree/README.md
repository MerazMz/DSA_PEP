<h2><a href="https://leetcode.com/problems/maximum-sum-bst-in-binary-tree/?envType=problem-list-v2&envId=binary-search-tree">1373. Maximum Sum BST in Binary Tree</a></h2><h3>Hard</h3><hr><p>Given a <strong>binary tree</strong> <code>root</code>, return <em>the maximum sum of all keys of <strong>any</strong> sub-tree which is also a Binary Search Tree (BST)</em>.</p>
